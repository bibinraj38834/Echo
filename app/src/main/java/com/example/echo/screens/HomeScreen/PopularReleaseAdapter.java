...
public class PopularReleaseAdapter extends RecyclerView.Adapter<PopularReleaseAdapter.ReleaseViewHolder> {
    private List<Releases> releaseList;
    private Context context;

    public PopularReleaseAdapter(List<Releases> releases, Context context) {
